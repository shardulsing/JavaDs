...
public class Graph {
	...
	public void addEdge(String vname1, String vname2, int cost) {
		...
		// vtx2.nbrs.put(vname1, cost);// 4k nbrs put A with agiven cost
...
//					}
					if (i <= V - 1) {
						...
						throw new Exception("-ve wt cyscle present");
					}
