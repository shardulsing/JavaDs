...
public class DungeonGame {
	...
	public static void main(String[] args) {
		...
		System.out.println(DungeonGameRec(arr, 0, 0, arr.length - 1, arr.length - 1));
		System.out.println(DungeonGameTD(arr, 0, 0, arr.length - 1, arr.length - 1, new int[arr.length][arr.length]));
